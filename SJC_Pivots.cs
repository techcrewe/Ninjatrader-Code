...
namespace NinjaTrader.Indicator
{
	...
	public class SJC_Pivots : Indicator
	{
		#region Variables
		...
		private	double				s2					= 0;
		private	double				s3					= 0;
        private double ppr1 = 0;
        private double pps1 = 0;
        private double r1r2 = 0;
        private double s1s2 = 0;
        private double r2r3 = 0;
        private double s2s3 = 0;
		...
		{
			Add(new Plot(Color.Green,"PP"));
			Add(new Plot(Color.DarkRed,"R1"));
            Add(new Plot(Color.DarkBlue, "S1"));
            Add(new Plot(Color.DarkRed,"R2"));
            Add(new Plot(Color.DarkBlue, "S2"));
            Add(new Plot(Color.DarkRed,"R3"));
            Add(new Plot(Color.DarkBlue, "S3"));
/*
            Add(new Plot(Color.DarkRed, "PPR1"));
            Add(new Plot(Color.DarkBlue, "PPS1"));
            Add(new Plot(Color.DarkRed, "R1R2"));
            Add(new Plot(Color.DarkBlue, "S1S2"));
            Add(new Plot(Color.DarkRed, "R2R3"));
            Add(new Plot(Color.DarkBlue, "S2S3"));
*/
...
namespace NinjaTrader.Indicator
{
    ...
    {
        private SJC_Pivots[] cacheSJC_Pivots = null;

        private static SJC_Pivots checkSJC_Pivots = new SJC_Pivots();

        /// <summary>
        /// Pivot Points.
        /// </summary>
        /// <returns></returns>
        public SJC_Pivots SJC_Pivots(Data.PivotRange pivotRangeType, Data.HLCCalculationMode priorDayHLC, double userDefinedClose, double userDefinedHigh, double userDefinedLow, int width)
        {
            return SJC_Pivots(Input, pivotRangeType, priorDayHLC, userDefinedClose, userDefinedHigh, userDefinedLow, width);
        }
